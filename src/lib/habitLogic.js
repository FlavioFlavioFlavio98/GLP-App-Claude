...
export function computeDayNet(userData, dateStr) {
  ...
  const extraPts = Math.round(
    (
      ...
      ((userData.meditationLog || {})[dateStr] || []).reduce((sum, s) => sum + (parseFloat(s.pts) || 0), 0) +
      ((userData.mealLog || {})[dateStr] || []).reduce((sum, s) => sum + (parseFloat(s.pts) || 0), 0) +
      (parseFloat((userData.dayRecapLog || {})[dateStr]?.pts) || 0) +
      ...
      ((userData.lifeAreaLog || {})[dateStr] || []).reduce((sum, s) => sum + (parseFloat(s.pts) || 0), 0)
    ) * 10
  ) / 10
...
export function calculateTotalScore(userData) {
  ...
  const dates = new Set([
    ...
    ...Object.keys(userData.meditationLog || {}),
    ...Object.keys(userData.mealLog || {}),
    ...Object.keys(userData.dayRecapLog || {}),
    ...Object.keys(userData.barefootLog || {}),
    ...Object.keys(userData.hangLog || {}),
    ...Object.keys(userData.mindSocialLog || {}),
    ...Object.keys(userData.lifeAreaLog || {}),
  ])
