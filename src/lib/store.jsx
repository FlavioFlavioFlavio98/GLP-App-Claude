  ...
  const actions = {
    ...
    async exportData() {
      ...
      try {
        ...
        // Data dell'ultimo backup manuale, per il banner promemoria (vive sul
        // documento, non in localStorage, così resta coerente tra dispositivi).
        if (state.authUserId === 'flavio') {
          await updateDoc(doc(db, 'users', 'flavio'), { lastDataExportAt: new Date().toISOString() })
        }
