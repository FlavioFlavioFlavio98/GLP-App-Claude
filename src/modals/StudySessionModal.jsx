...
import { getStudyRate } from '../lib/workoutStats'
...
export default function StudySessionModal() {
  ...
  if (modal !== 'study') return null
  if (authUserId !== 'flavio') return null

  const rate = getStudyRate()
  ...
  async function handleAdd() {
    setSaving(true)
    await actions.addStudySession(duration, note, sessionDate)
    setSaving(false)
    actions.closeModal()
  }
      ...
      <div style={{
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          <textarea
            ...
            placeholder="Es. video su come fare bene le flessioni"
            maxLength={200}
            rows={2}
